...
namespace SBMap
{
    ...
    {
        int32 maximum_tile_width = SDL_clamp(m_Tileset.atlas.width, TILE_MINIMUM_WIDTH, TILE_MAXIMUM_WIDTH);
        int32 maximum_tile_height = SDL_clamp(m_Tileset.atlas.height, TILE_MINIMUM_HEIGHT, TILE_MAXIMUM_HEIGHT);
